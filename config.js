...
const CONFIG = {
    ...
    questions: {
        first: {
            ...
            secretAnswer: "Forse dovresti smetterla di provare a cliccare Si o No, clicca qui"           // Secret hover message
        },
        second: {
        ...
        third: {
            ...
            yesBtn: "Si!",                                             // Text for "Yes" button
            noBtn: "Solo se ti sbrighi a portarmi al Sushi"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "Fammi capire quanto vuoi andare al Sushi...",  // Shows when they go past 5000%
        high: "Vedi che non puoi mangiare tutto il sushi !!!",              // Shows when they go past 1000%
